...
@NgModule({
    imports: [
        ...
        JhipsterTaskSharedModule.forRoot(),
        JhipsterTaskCoreModule,
        JhipsterTaskHomeModule,
        JhipsterTaskAccountModule,
